...
public class SelfNode implements Node {
	...
	public final double performance_modifier = 0.10; // Percentage, how intense should resource usage be? Higher value means more intense but faster and more dedicated. Lower means slower but less impactful of host system.
}
