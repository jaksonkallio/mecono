...
public class Protocol {
	...
	public static final ParcelType[] parcel_type_codes = {ParcelType.PING, ParcelType.PING_RESPONSE, ParcelType.FIND, ParcelType.FIND_RESPONSE, ParcelType.DATA, ParcelType.DATA_RECEIPT, ParcelType.ANNC, ParcelType.UNKNOWN};
}
